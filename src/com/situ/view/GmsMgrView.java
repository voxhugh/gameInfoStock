...
public class GmsMgrView {
    ...
    /*查询*/
    public List<Gms> queryView(Scanner sc){

        sc=new Scanner(System.in);
        System.out.println("输入要查询的游戏名关键词");
        String str = sc.nextLine();
        List<Gms> list = gmsService.query(str);
        ...
        for (Gms gm:list) {
            System.out.println(gm.getId()+"\t\t"+gm.getName()+"\t\t\t\t"+gm.getPrice()+"\t\t"+gm.getLprice()+
                    "\t\t"+gm.getLkrate()+"\t\t\t\t"+gm.getMonline()+"\t\t"+gm.getAvgtime()+
