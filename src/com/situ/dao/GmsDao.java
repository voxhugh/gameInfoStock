...
public class GmsDao {
    ...
    public boolean add(Gms gms){
        ...
        Object param[] = {gms.getName(),gms.getPrice(),gms.getLprice(),gms.getLkrate(),gms.getMonline(),gms.getAvgtime(),
                gms.getDeveloper(), gms.getPublisher()};
        /*1、sql语句*/
    ...
    public boolean update(Gms gms){
        Object param[] = {gms.getName(),gms.getPrice(),gms.getLprice(),gms.getLkrate(),gms.getMonline(),
                gms.getAvgtime(),gms.getDeveloper(),gms.getPublisher(),gms.getName()};
        /*1、sql语句*/
